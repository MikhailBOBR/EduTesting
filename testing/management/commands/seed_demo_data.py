...
def build_course_specs():
    base_specs = [
        ...
        },
        {
            ...
            'semester': SemesterChoices.SPRING,
            'academic_year': '2025/2026',
            'assessment_policy': 'Учитываются тематические квизы, разборы кейсов и итоговый контроль.',
        ...
        },
        {
            ...
            'description': 'Студенты проектируют архитектуру, БД, интерфейсы, тесты и презентуют готовый проект.',
            'audience': 'Студенты 4 курса',
            'semester': SemesterChoices.SPRING,
            'academic_year': '2025/2026',
            'assessment_policy': 'Основной вес имеют этапы проекта, обзор архитектуры и итоговое тестирование.',
            ...
            'quizzes': [
                ...
                {
                    'title': 'Тестирование и презентация проекта',
                    'description': 'Тест по автоматическим проверкам и подготовке проекта к демонстрации.',
                    ...
                    'questions': [
                        ...
                        q('Что важно показать при демонстрации веб-приложения?', 'Презентация', QuestionType.MULTIPLE, 'intermediate', 4, 'При демонстрации полезно показать архитектуру, БД, сценарии и тесты.', [('Архитектуру приложения', True), ('Структуру БД', True), ('Ключевые сценарии', True), ('Только цветовую палитру', False)]),
