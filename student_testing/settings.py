...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': (
        'API для платформы онлайн-тестирования с акцентом на сильные backend-сценарии.\n\n'
        'Что удобно показывать прямо в Swagger UI:\n'
        '* токен-авторизацию и персональные роли;\n'
        '* студенческий поток: запись на курс, старт попытки, автосохранение черновика, отправка и достижения;\n'
        '* преподавательский поток: аналитика курса, контроль подозрительных попыток, индивидуальные условия и апелляции.\n\n'
